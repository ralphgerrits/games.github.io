...
function draw() {
  ...
  tekenBoom(50); // Eerste boom (achter het huis)
  tekenBoom(150); // Tweede boom (achter het huis)
  tekenBoom(250); // Derde boom (achter het huis)
 
  tekenHuis();

  tekenZon(mouseX, schaal); // Tekent de zon bovenop alles
